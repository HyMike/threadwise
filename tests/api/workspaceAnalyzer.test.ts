...
describe('Workspace Analyzer API', () => {
  ...
  describe('POST /api/workspaces/:workspaceId/analyze', () => {
    it('should analyze a workspace successfully', async () => {
      console.log(`Testing analyze workspace at: ${API_URL}/api/workspaces/${WORKSPACE_ID}/analyze`);
    ...
    it('should handle concurrent requests', async () => {
      const requests = [
        axios.post(`${API_URL}/api/workspaces/${WORKSPACE_ID}/analyze`, {}, { timeout: 120000 }),
        axios.post(`${API_URL}/api/workspaces/${WORKSPACE_ID}/analyze`, {}, { timeout: 120000 })
      ];
